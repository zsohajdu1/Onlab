        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LftDescription = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Teams_Games_TeamGameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tournaments_TournamentFormats_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TournamentOfMatchId = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EliminationId = table.Column<int>(type: "int", nullable: true),
                    RoundRobinId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_TournamentFormats_EliminationId",
                        column: x => x.EliminationId,
                        principalTable: "TournamentFormats",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_TournamentFormats_RoundRobinId",
                        column: x => x.RoundRobinId,
                        principalTable: "TournamentFormats",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_Tournaments_TournamentOfMatchId",
                        column: x => x.TournamentOfMatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_EliminationId",
                table: "Matches",
                column: "EliminationId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_RoundRobinId",
                table: "Matches",
                column: "RoundRobinId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_TournamentOfMatchId",
                table: "Matches",
                column: "TournamentOfMatchId");
